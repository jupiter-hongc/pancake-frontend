...
import { NewBetResponse, UserResponseBNB } from '../queries/newTokenQueries'
import { transformBetResponseToken, transformRoundResponseToken, transformUserResponseToken } from './tokenTransformers'

export const newTransformBetResponse = (betResponse: NewBetResponse): Bet => {
...
export const newTransformUserResponse = (userResponse: UserResponseBNB): PredictionUser => {
