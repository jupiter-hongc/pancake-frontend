import type { Bet, Round, PredictionUser } from "@/types"
import type { RoundResponse } from "@/types/responseType"
import { BetPosition } from ".."
import type { BetResponseBNB } from "../queries/bnbQueries"
import type { BetResponseCAKE } from "../queries/cakeQueries"
import type { NewBetResponse } from "../queries/newTokenQueries"
...
export const transformBetResponseToken = (betResponse: any): Bet => {
  return {
    id: betResponse.id,
...
export const transformUserResponseToken = (userResponse: any): PredictionUser => {
