...
import { BetResponseCAKE, UserResponseCAKE } from '../queries/cakeQueries'
import { transformRoundResponseToken, transformUserResponseToken, transformBetResponseToken } from './tokenTransformers'

export const transformBetResponseCAKE = (betResponse: BetResponseCAKE): Bet => {
...
export const transformUserResponseCAKE = (userResponse: UserResponseCAKE): PredictionUser => {
